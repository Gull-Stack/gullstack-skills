...
| `design-standard-v3.md` *(v3.2.1 — 2026-08-17)* | Editorial Light template spec — light-dominant layout, full-bleed heroes with proof in the first view, one grammar across interiors (§10: type-only, derived meta, scoped accent, article headers inherit scale), grotesk/Archivo + one serif accent, imagery-over-icon-boxes, section order, first-class Mobile section |
